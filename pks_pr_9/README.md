...
1) Написал обработчики запросов в файле **main.go** ветка ***backend*** (https://github.com/1abobik1/backend_pks_pr9)

В данной работе я использовал хранение двух структур: **Product** (информация о товаре) и **Item** (элемент корзины).
...
2) Создал новый проект Flutter. Добавила библиотеку для работы с API (файл **pubspec.yaml**)
...
4) Продолжил работу над проектом с 8-ой практической, получая данные через API
